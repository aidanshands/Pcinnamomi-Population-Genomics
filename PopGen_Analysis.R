...
library(googleway)
library(ggmapstyles)
setwd('/Users/manosalvalab/Desktop/Aidan/Pc_PopGen_2022/R_Analysis_Final')

#-------------------------------------------------------------------------------
# Importing Annotation Data
#-------------------------------------------------------------------------------
# Annotations 
annot = read.csv('annotations/Pc_Tree_Annot.FINAL.v3.csv', header = T)
...
#-------------------------------------------------------------------------------
vcf_file_OG = 'vcfs/Pc_only136.p2.f1SV.vcft_dp4_Q20_NoSingleton_noMD_NoRepeats.recode.vcf'
...
# Trees
Tree = read.beast("583K_outputs/Pc136_583K_UPGMA_Tree_1000BSR_FigtreeOut.nex") 
...
style_list <- fromJSON("MapStlye.json", simplifyVector = FALSE)
...
CA_Annot = read.csv('annotations/GGMap_Pc_Cluster_Loc_Data_CA.v2.csv', header = T)
